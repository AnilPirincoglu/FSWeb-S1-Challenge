...
console.log("\nDizideki ilk fenomenin profil adı :", fenomenler[0]["profile"], '\n');
...
console.log("İsim Düzeltildi :", fenomenler[6].profile, '\n');
...
function fenomenEkle(arr, index, nickName, follow, posted, platformName) {
  const copyArr = [...arr];
  const newFenomen = {
    "number": index,
    "profile": nickName,
